      ...
      <article className="max-w-3xl mx-auto px-6 py-10">
        ...
        <section className="mb-8">
          <div className="relative w-full" style={{ paddingBottom: '100%' }}>
            <img
              src="https://static.vecteezy.com/system/resources/thumbnails/049/695/866/small_2x/hand-holding-bitcoin-crypto-coin-cryptocurrency-digital-money-investment-golden-blockchain-symbol-virtual-cash-exchange-market-savings-trade-pay-commerce-stock-altcoin-future-concept-video.jpg"
              alt="Bitcoin Growth"
